...
public class OrganizationDaoDBTest {
    ...
    public void testDeleteOrganizationById() {
        ...
        assertNull(organizationFromDao); //Assert if organization was deleted

        Super superWithoutOrganization = superDao.getSuperById(heroVillain.getId());

        assertEquals(superWithoutOrganization.getOrganizations().size(), 0); //Assert that this super doesn't have organization        
    }
